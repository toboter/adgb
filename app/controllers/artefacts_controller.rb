class ArtefactsController < ApplicationController
  ...
  # GET /artefacts.json
  def index
    @artefacts = Artefact.search(params[:q]).order(bab_rel: :asc).paginate(:page => params[:page], :per_page => 20)
  end
  ...
  private
    ...
    def artefact_params
      params.require(:artefact).permit(:bab_rel, :grabung, :bab, :bab_ind, :b_join, :b_korr, :mus_sig, :mus_nr, :mus_ind, :m_join, :m_korr, :kod, :grab, :text, :sig, :diss, :mus_id, :standort_alt, :standort, :mas1, :mas2, :mas3, :f_obj, :abklatsch, :abguss, :fo_tell, :fo1, :fo2, :fo3, :fo4, :fo_text, :UTMx, :UTMxx, :UTMy, :UTMyy, :inhalt, :period, :arkiv, :text_in_archiv, :jahr, :datum, :zeil2, :zeil1, references_attributes: [:id, :verfasser, :publ, :jahr, :seite, :_destroy], illustrations_attributes: [:id, :ph, :ph_nr, :ph_add, :position, :_destroy], people_attributes: [:id, :person, :titel, :_destroy])
    end
end
